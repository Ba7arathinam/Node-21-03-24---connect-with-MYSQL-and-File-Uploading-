...
//PUG Concept (Template Engine or View Engine)
app.set('view engine', 'pug'); //for PUG you have to set these two values  and Install "npm i pug"
app.set('views', './views'); // go through this website "https://pugjs.org/api/migration-v3.html"
app.get('/pug', (req, res) => {
